...
class Tweets(Dataset):
    ...
    def load_preprocessed(self):
        try: 
            ...
            ## For gcp 
            with open('/gcs/tweet_classification/data/processed/train_processed.npy', 'r') as f:
                data_train = f.readlines()
            with open('/gcs/tweet_classification/data/processed/test_processed.npy', 'r') as f:
